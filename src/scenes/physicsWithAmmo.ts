...
import { ActionEvent, ActionManager, Color3, EnvironmentHelper, ExecuteCodeAction, MeshBuilder } from '@babylonjs/core';
...
class PhysicsSceneWithAmmo implements CreateSceneClass {
    ...
    createScene = async (engine: Engine, canvas: HTMLCanvasElement): Promise<Scene> => {
        ...
        sphere1.physicsImpostor = new PhysicsImpostor(sphere1, PhysicsImpostor.SphereImpostor, { mass: 5, restitution: 0.8 }, scene);
        sphere2.physicsImpostor = new PhysicsImpostor(sphere2, PhysicsImpostor.SphereImpostor, { mass: 2, restitution: 1.5 }, scene);
